<?php
// filepath: c:\wamp64\www\GestionIPCH\app\viewer\miperfil.php
...
// CORRECCIÓN: Manejar avatar correctamente
...
<style>
    ...
    .btn-photo {
        background: rgba(255,255,255,0.05); 
        color: var(--calypso);
        border: 1.5px solid var(--calypso); 
        padding: 10px 20px;
        border-radius: 10px; 
        cursor: pointer; 
        width: 100%; 
    ...
    <div class="profile-container">
        ...
        <div class="profile-grid">
            ...
            <div class="glass-card" style="text-align:center;">
                ...
                <p style="color:var(--calypso); font-weight:700; margin:5px 0 0 0;">Miembro</p>
                
                <?php if($esAlabanza): ?>
                <span class="user-role-badge">
                    <i class="fas fa-music"></i> Grupo de Alabanza
                </span>
                <?php endif; ?>
            ...
            <div class="glass-card">
                <h2 style="color:white; margin-bottom:25px;">
                    <i class="fas fa-user-edit" style="color:var(--calypso); margin-right:10px;"></i>
                    Datos Personales
                </h2>
                ...
                <form id="formDatos">
                    ...
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" class="form-control" name="nombre" value="<?php echo htmlspecialchars($sesion['nombre']); ?>" required>
                    </div>

                    <div class="form-group">
                        <label>Apellido</label>
                        <input type="text" class="form-control" name="apellido" value="<?php echo htmlspecialchars($sesion['apellido']); ?>" required>
                    </div>

                    <div class="form-group">
                        <label>Correo Electrónico</label>
                        <input type="email" class="form-control" name="correo" value="<?php echo htmlspecialchars($sesion['correo']); ?>" required>
                    </div>

                    <div class="form-group">
                        <label>Teléfono</label>
                        <input type="text" class="form-control" name="telefono" value="<?php echo htmlspecialchars($sesion['telefono']); ?>" required>
                    </div>
...
<div id="modalPass" class="modal-center">
    <div class="modal-box">
        <h2 style="color:white; margin-bottom:20px;">
            <i class="fas fa-key" style="color:var(--calypso); margin-right:10px;"></i>
            Cambiar Contraseña
        </h2>
        <form id="formPass">
            <input type="hidden" name="idusuario" value="<?php echo $sesion['idusuario']; ?>">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="pass_nueva" required minlength="6">
            </div>

            <div class="form-group">
                <label>Confirmar Nueva Contraseña</label>
                <input type="password" class="form-control" id="pass_confirmar" name="pass_confirmar" required minlength="6">
            </div>
...
<script src="/assets/js/miperfil.js?v=<?php echo time(); ?>"></script>
</body>
</html>