...
<style>
    ...
    .b-pendiente { background: rgba(245, 158, 11, 0.2); color: #f59e0b; border: 1px solid #f59e0b; } /* Naranja */
    .b-aprobada { background: rgba(16, 185, 129, 0.2); color: #10b981; border: 1px solid #10b981; } /* Verde */
    .b-rechazada { background: rgba(239, 68, 68, 0.2); color: #ef4444; border: 1px solid #ef4444; } /* Rojo */
            ...
            <div style="display:flex; justify-content:space-between; align-items:center;">
                <div>
                    ...
                    <p class="calendar-description">
                        Modera peticiones de los miembros y publica motivos pastorales directamente.
                    </p>
                </div>
                <button class="btn-add-activity" onclick="openModal()">
                    <i class="fas fa-plus-circle"></i> Publicar Motivo Pastoral
                </button>
            </div>
        </div>
    ...
    <div class="modal-content" style="max-width: 500px;">
        ...
        <form id="oracionForm">
            <div class="form-group">
                ...
                <small style="color:var(--calypso);">
                    <i class="fas fa-check-circle"></i> Como Pastor, esta petición se publicará automáticamente.
                </small>
            </div>
...
<script src="/assets/js/oraciones.js"></script>
</body>
</html>