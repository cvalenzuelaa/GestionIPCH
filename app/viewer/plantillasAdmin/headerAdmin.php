...
<style>
    ...
    /* --- ANIMACIÓN COMPARTIDA (CLAVE PARA QUE SEAN IGUALES) --- */
    .notif-dropdown, #dropdownMenu {
        position: absolute; top: 55px;
        background: #151f2e; /* Slate oscuro */
        ...
        pointer-events: none; /* NO SE PUEDE CLICKEAR MIENTRAS ESTÁ OCULTO */
    ...
    .notif-dropdown.active, #dropdownMenu.active { 
        ...
        pointer-events: auto; /* AHORA SÍ ES CLICKEABLE */
    }

    /* --- AJUSTES ESPECÍFICOS NOTIFICACIONES --- */
    ...
    /* --- AJUSTES ESPECÍFICOS MENÚ USUARIO --- */
    #dropdownMenu {
        right: 0; 
        width: 200px;
        padding: 5px 0;
        /* IMPORTANTE: Forzamos block para que exista y pueda animarse con opacity */
...
<nav class="navbar">
    ...
    <div class="nav-links">
        <a href="/dashadmin">Inicio</a>
        <a href="/gestionmiembros">Miembros</a>
        <a href="/actividades">Actividades</a>
        <a href="/tesoreria">Tesoreria</a>
        <a href="/inventario">Inventario</a>
        <a href="/alabanzas">Alabanzas</a>
        <a href="/sermones">Sermones</a>
        <a href="/oraciones">Oraciones</a>
    </div>
        ...
        <div class="user-menu" id="userMenu" style="cursor:pointer; display:flex; align-items:center;">
            ...
            <div class="dropdown-menu" id="dropdownMenu">
                <div style="padding: 10px 20px; border-bottom: 1px solid rgba(255,255,255,0.1); margin-bottom:5px;">
                    ...
                    <span style="display:block; color:#94a3b8; font-size:0.75rem;"><?php echo ucfirst($sesion['rol']); ?></span>
                </div>
                <a href="/perfiladmin"><i class="fas fa-edit" style="margin-right:10px; width:20px; text-align:center;"></i> Mi Perfil</a>
                <a href="/gestionusuarios"><i class="fas fa-user" style="margin-right:10px; width:20px; text-align:center;"></i> Gestión de usuarios</a>
...
<script src="/assets/js/headerAdmin.js?v=<?php echo time(); ?>"></script>
